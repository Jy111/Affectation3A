                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <c:choose>
                                <c:when test="${abb == null}">
                                    <label path="<%=strChM%>"><%=strAttrM%></label>
                                    <form:select id="<%=strIdM%>" path="<%=strChM%>" onclass="combobox" style="min-width:550px">
                                        <option>------------------------------------- Pas de choix -------------------------------------</option>
                                        <c:forEach var="m" items="${mAvailable}">
                                            <option>${m.stringForForm}</option>
                                        </c:forEach>
                            ...
                            <c:choose>
                                <c:when test="${!hasFilledResume}">
                                    ...
                                    <div class="input-append">
                                        <label for="resumeInput"><input id="resumeInput" onclick="$('input[id=resume]').click();" type="text" style="min-width: 300px"> <a class="btn" onclick="$('input[id=resume]').click();">Parcourir...</a> </label>
                                    </div>
                                    <br />
                                </c:when>
                                <c:otherwise>

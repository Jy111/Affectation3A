				...
				<ul class="nav nav-list">
					...
					<c:choose>
						<c:when test="${specialization.type == specialization.JOB_SECTOR }">
							...
							<li class="active"><a href="${pageContext.request.contextPath}/responsable/run/statistics/${specialization.abbreviation}/inverse-repartition">Répartition parcours</a></li>
						</c:when>
						<c:otherwise>
							...
							<li class="active"><a href="${pageContext.request.contextPath}/responsable/run/statistics/${specialization.abbreviation}/inverse-repartition">Répartition filières</a></li>
						</c:otherwise>
					</c:choose>
				</ul>
			</div>

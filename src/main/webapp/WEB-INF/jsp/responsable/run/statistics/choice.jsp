		...
		<div class="row">
			<div class="span2">
				<ul class="nav nav-list">
					...
					<li class="active"><a href="${pageContext.request.contextPath}/responsable/run/statistics/${specialization.abbreviation}/choice1">Parcours/filières</a></li>
					<c:choose>
					...
					<c:forEach var="i" begin="1" end="5" step="1">
						<c:choose>
							<c:when test="${i == choiceNumber}">
								<li class="active"><a href="${pageContext.request.contextPath}/responsable/run/statistics/${specialization.abbreviation}/choice${i}">Choix ${i}</a></li>
							</c:when>
							<c:otherwise>
								<li><a href="${pageContext.request.contextPath}/responsable/run/statistics/${specialization.abbreviation}/choice${i}">Choix ${i}</a></li>
							</c:otherwise>
						</c:choose>
					</c:forEach>
				</ul>

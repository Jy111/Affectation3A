...
<div class="container">
    ...
    <div class="row">
        <div class="span2">
            <ul class="nav nav-list">
                ...
                <c:forEach var="spec" items="${allJs}" varStatus="status">
                    <c:choose>
                        <c:when test="${spec.abbreviation == abbreviation}">
                            <li><a href="${pageContext.request.contextPath}/admin/run/main/choices/job-sector/details/${abbreviation}/choice1">${spec.abbreviation}</a></li>
                        </c:when>
                        <c:otherwise>
                ...
                <c:forEach var="spec" items="${allM}" varStatus="status">
                    <c:choose>
                        <c:when test="${spec.abbreviation == abbreviation}">
                            <li class = "active"><a href="${pageContext.request.contextPath}/admin/run/main/choices/master/details/${abbreviation}">${spec.abbreviation}</a></li>
                        </c:when>
                        <c:otherwise>
        ...
        <div class="span7">
				...
				<span class="lead"> <a href="${pageContext.request.contextPath}/admin/common/edit/m/${abbreviation}"> ${specialization.name} (${specialization.abbreviation}) </a>
				</span> <br /> <br />
            <c:choose>
                ...
                <c:otherwise>
                    <p>
                        Aucun elève n'a pour l'instant choisi ce Master.
                    </p>
                </c:otherwise>
            </c:choose>
        </div>

    ...
    <div class="row">
        <div class="span2">
            <ul class="nav nav-list">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/admin/run/main/choices/master/synthese">Synthèse</a></li>
        ...
        <div class="span7">
            <c:forEach var="specialization" items="${allM}" varStatus="status">
					<span class="lead"> <a href="${pageContext.request.contextPath}/admin/common/edit/m/${specialization.abbreviation}"> ${specialization.name} (${specialization.abbreviation}) </a>
					</span>
                <br />
                <br />
                <c:choose>
                    ...
                    <c:otherwise>
                        <p>
                            Aucun elève n'a choisi ce Master.
                        </p>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
